...
class Swe4rTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @test_date_jd = 2444838.972916667  # Aug 22 1981, 11:35
    @test_lat = 45.45
    @test_lon = -112.183333
    @test_altitude = 1524
  end
  ...
  def test_swe_julday
    assert_float_equal(2444838.972917, Swe4r::swe_julday(1981, 8, 22, 11.35))
  end
  ...
  def test_swe_set_topo
    assert_equal(nil, Swe4r::swe_set_topo(@test_lon, @test_lat, @test_altitude))
  end

  def test_swe_set_sid_mode
    assert_equal(nil, Swe4r::swe_set_sid_mode(Swe4r::SE_SIDM_LAHIRI, 0, 0))
    assert_equal(nil, Swe4r::swe_set_sid_mode(Swe4r::SE_SIDM_USER, 2415020.5, 22.460489112721632))
  end
  ...
  def test_swe_houses
    ...
    systems.each do |s|
      ...
      assert_not_nil(result, "House system #{s} calculation failed")
    end
